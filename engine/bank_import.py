...
DEFAULT_KEYWORD_MAP: list[tuple[str, str, str, str]] = [
    ...
    ("VEG VIERA", "Dining", "Restaurants", "Fast Food / Food Outings"),
    ...
    ("ZELLE PAYMENT TO GILBERTO", "Home Services & Subs", "Home Cleaning Team", "Home Cleaning"),
    ("LG - VIERA", "Utilities", "Other Utilities", "Other Utitlities"),
    ...
    ("VIERA DANCE", "School", "Kids Activities / Memberships", "Max Memberships"),
    ...
    ("HARBOR CITY GYM", "School", "Kids Activities / Memberships", "Max Memberships"),
    ("KOHLS", "Shopping", "Malls / Retail", "Malls"),
    ("KOHL'S", "Shopping", "Malls / Retail", "Malls"),
    ("DCL SHIP", "Home Services & Subs", "Theme Parks", "Park Pass"),
    ("ADDISON VILLAGE", "Housing", "HOA / Community Dues", "Homeowners Addison Vill Dues"),
    ...
    ("CENTRAL VIERA COMM", "Housing", "HOA / Community Dues", "Homeowners Addison Vill Dues"),
    ("HOMETITLELOCK", "Home Services & Subs", "Annual fees", "Home Services & Subs"),
    ...
    ("CITY OF COCOA", "Utilities", "Water", "Water"),
    ("FBS*CITY OF COCOA", "Utilities", "Water", "Water"),
    ...
    ("HARRIS GCSD CAFE", "School", "After-school", "after-school"),
    ("PELOTON", "Home Services & Subs", "Peloton Membership", "Peloton Membership"),
    ("VIERA SUNTREE LITTL", "School", "Kids Activities / Memberships", "Max Memberships"),
    ("PP*VIERA SUNTREE", "School", "Kids Activities / Memberships", "Max Memberships"),
    # Auto loans / wash
    ("BONIFACE-HIERS KIA", "Auto", "Kia Rio", "Kia Rio"),
    ("BONIFACE-HIERS K", "Auto", "Kia Rio", "Kia Rio"),
    ...
    ("GALLIGAN DENTAL", "Health & Personal", "Medical", "Medical"),
    ...
    ("SQ *VIERA SUNTREE", "Dining", "Restaurants", "Fast Food / Food Outings"),
    ("WHITS VIERA", "Dining", "Restaurants", "Fast Food / Food Outings"),
    ...
    ("ZELLE PAYMENT TO JUAN G LAWN", "Home Services & Subs", "Lawn Service", "Lawn Service"),
    ...
    ("ZELLE PAYMENT TO BARBARA", "School", "Tutoring", "Tutor"),
    ...
    ("ABE HARDOON", "Entertainment", "Family Outings", "Family Outings"),
    ...
    # Transfers / savings
    ("ONLINE TRANSFER TO GMR", "Transfers / Savings", "Savings", "Savings"),
